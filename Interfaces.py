...
class Pause:
    def __init__(self, xoy, textures=Textures.Textures()):
        ...
        self.button_setting = Button(textures.pause['button_setting'], (xoy[0], xoy[1] + 120 * textures.resizer))
        self.button_save = Button(textures.pause['button_save'], (xoy[0], xoy[1] + 40 * textures.resizer))
        self.surface = Surface(self.background, self.button_menu, self.button_setting, self.button_save)
